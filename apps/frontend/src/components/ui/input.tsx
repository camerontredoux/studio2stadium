...
function Input({
  ...
  return (
    ...
    >
      <InputPrimitive
        className={cn(
          "placeholder:text-muted-foreground/72 h-8.5 w-full min-w-0 rounded-[inherit] px-[calc(--spacing(3)-1px)] leading-8.5 outline-none autofill:shadow-[inset_0_0_0_1000px_var(--color-background)] autofill:[-webkit-text-fill-color:var(--color-foreground)] disabled:cursor-not-allowed sm:h-7.5 sm:leading-7.5",
          size === "sm" &&
