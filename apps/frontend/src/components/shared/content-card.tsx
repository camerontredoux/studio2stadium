  ...
  return (
    ...
    >
      <FramePanel side="top">
        ...
        <div className="relative p-3 sm:p-4 flex flex-col gap-2.5 flex-1 bg-linear-to-br from-brand/10 via-background to-background group-hover:from-brand/8 group-hover:via-brand/4 transition-colors">
          <div
          ...
          <div className="flex flex-col gap-1.5 flex-1">
            <h3 className="font-semibold text-base leading-snug line-clamp-2 sm:min-h-11 group-hover:text-brand transition-colors">
              {title}
            </h3>
            {children}
          </div>
