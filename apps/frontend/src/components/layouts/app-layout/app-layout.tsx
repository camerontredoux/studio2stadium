...
import { MobileTabs } from "./sidebar/mobile-tabs";
        ...
        <div className="pt-12 max-w-2xl lg:max-w-5xl xl:max-w-7xl mx-auto flex">
          ...
          {pathname === "/" ? (
            <>
              ...
              <main className="hidden lg:block flex-1 min-w-0 p-2 xl:pl-2 xl:py-4">
                {children}
              </main>
              <SideInfo />
            </>
          ) : (
            <main className="flex-1 min-w-0 p-2 mobile:pb-16 md:p-2 xl:py-4">
              {children}
            </main>
          )}
        </div>
