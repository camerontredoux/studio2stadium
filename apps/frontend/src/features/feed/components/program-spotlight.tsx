...
export function ProgramSpotlight() {
  return (
    <div className="rounded-xl border overflow-clip">
      <div className="relative overflow-clip p-4 bg-linear-to-br from-brand/10 via-brand/5 to-background ">
        <div className="absolute -left-2 opacity-10 flex items-center text-brand gap-2 -top-1 -z-10">
      ...
      <div className="bg-linear-to-tl from-brand/10 via-background to-background border-t p-2 sm:p-4 grid grid-cols-1 gap-2 sm:gap-4 sm:grid-cols-2">
