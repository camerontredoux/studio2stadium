...
export const Route = createFileRoute("/_app/(routes)/playground")({
...
function RouteComponent() {
  ...
  const onValueChange = React.useCallback(
    (field: keyof IInput) => (maskedValue: string) => {
      setInput((prev) => ({
        ...prev,
        [field]: maskedValue,
      }));
  ...
  return (
    <div className="p-4">
      ...
      <div className="flex max-w-xs mx-auto flex-col gap-2">
        <MaskInput
          id={`test-date1`}
          mask="date"
          placeholder="Enter your birth date"
        ...
        <Label htmlFor={`test-date`}>Birth date</Label>
      ...
      <Tooltip>
        ...
        <TooltipContent side="right" align="center">
          Content with length here! How does it appear?
        </TooltipContent>
      </Tooltip>
...
import { AlertParticle, explore } from "@/features/explore";
