...
export type ProcessedEventWhereInput = {
  ...
  event_id?: Prisma.StringFilter<"ProcessedEvent"> | string
  event_type?: Prisma.StringFilter<"ProcessedEvent"> | string
  processed_at?: Prisma.DateTimeFilter<"ProcessedEvent"> | Date | string
}
...
export type ProcessedEventScalarWhereWithAggregatesInput = {
  ...
  event_id?: Prisma.StringWithAggregatesFilter<"ProcessedEvent"> | string
  event_type?: Prisma.StringWithAggregatesFilter<"ProcessedEvent"> | string
  processed_at?: Prisma.DateTimeWithAggregatesFilter<"ProcessedEvent"> | Date | string
}
...
export type ProcessedEventOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"event_id" | "event_type" | "processed_at", ExtArgs["result"]["processedEvent"]>
...
export interface ProcessedEventDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const processedEventWithEvent_idOnly = await prisma.processedEvent.findMany({ select: { event_id: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many ProcessedEvents and only return the `event_id`
   * const processedEventWithEvent_idOnly = await prisma.processedEvent.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more ProcessedEvents and only return the `event_id`
   * const processedEventWithEvent_idOnly = await prisma.processedEvent.updateManyAndReturn({
   *   select: { event_id: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface ProcessedEventFieldRefs {
  readonly event_id: Prisma.FieldRef<"ProcessedEvent", 'String'>
  readonly event_type: Prisma.FieldRef<"ProcessedEvent", 'String'>
  readonly processed_at: Prisma.FieldRef<"ProcessedEvent", 'DateTime'>
}
