...
export type OutboxEventWhereInput = {
  ...
  published_at?: Prisma.DateTimeNullableFilter<"OutboxEvent"> | Date | string | null
}
...
export type OutboxEventScalarWhereWithAggregatesInput = {
  ...
  published_at?: Prisma.DateTimeNullableWithAggregatesFilter<"OutboxEvent"> | Date | string | null
}
...
export type OutboxEventOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "type" | "payload" | "created_at" | "published_at", ExtArgs["result"]["outboxEvent"]>
...
export interface OutboxEventFieldRefs {
  ...
  readonly published_at: Prisma.FieldRef<"OutboxEvent", 'DateTime'>
}
