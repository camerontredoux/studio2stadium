...
type AdminEventsSchoolIdPatch = {
  request: MakeTuyauRequest<InferInput<typeof import('../app/modules/admin/edit-school-event/validator.ts')['schema']>>
  response: MakeTuyauResponse<import('../app/modules/admin/edit-school-event/controller.ts').default['handle'], true>
}
type AdminEventsGlobalIdPatch = {
